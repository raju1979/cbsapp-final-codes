...
import { ShowMegaStat } from '../show-mega-stat/show-mega-stat';
...
/*
  Generated class for the MegaQuestions page.

  See http://ionicframework.com/docs/v2/components/#navigation for more info on
  Ionic pages and navigation.
*/
@Component({
  selector: 'page-mega-questions',
  templateUrl: 'mega-questions.html',
  animations: [
    trigger('fadeInOut', [
...
export class MegaQuestions {
   ...
   */
  presentGridModal() {
    let modal = this._modalCtrl.create(ShowMegaStat, { id: this.passedId });
